...
class TopRatedMoviesViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.moviesService.fetchTopRatedMovies(completion: self.fetchMoviesCompleted)
    }
    ...
    private func loadMore() {
        ...
        self.moviesService.fetchTopRatedMovies(pageIndex: self.currentPageIndex, completion: self.fetchMoviesCompleted)
    }
    ...
    private func updateView(_ movies: [Movie]) {
        ...
        self.moviesTableView.backgroundView?.isHidden = !self.movies.isEmpty
